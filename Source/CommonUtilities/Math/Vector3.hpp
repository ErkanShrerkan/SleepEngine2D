...
namespace CommonUtilities
{
	...
	public:
		...
		Vector3<T>(const T& aX, const Vector2<T>& aYZ)
		{
			x = aX;
			y = aYZ._1;
			z = aYZ._2;
		...
		Vector2<T> ToXX() const	{ return Vector2<T>(x, x); }
		Vector2<T> ToXY() const	{ return Vector2<T>(x, y); }
		Vector2<T> ToXZ() const	{ return Vector2<T>(x, z); }
		Vector2<T> ToYX() const	{ return Vector2<T>(y, x); }
		Vector2<T> ToYY() const	{ return Vector2<T>(y, y); }
		Vector2<T> ToYZ() const	{ return Vector2<T>(y, z); }
		Vector2<T> ToZX() const	{ return Vector2<T>(z, x); }
		Vector2<T> ToZY() const	{ return Vector2<T>(z, y); }
		Vector2<T> ToZZ() const	{ return Vector2<T>(z, z); }
	};
