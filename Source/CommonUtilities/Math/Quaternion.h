...
public:
	...
	void getRotationMatrix(Matrix4x4f& dest, bool affectPosition = true) const;
#endif
...
inline void Quaternion::getRotationMatrix(Matrix4x4f& dest, bool affectPosition) const
{
