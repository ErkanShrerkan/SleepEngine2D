...
#define JSMCR_EXPOSE_ARG_4(jxm_var, jxm_name, jxm_special, jxm_unique) \
Singleton<JsonManager>().ExposeVariableMacro(&jxm_var, #jxm_var, jxm_name, __FILE__, jxm_special, jxm_unique)

#define JSMCR_EXPAND(jxm_args) jxm_args
#define JSMCR_DEDUCE_MACRO(jxm_4, jxm_3, jxm_2, jxm_1, jxm_Name, ...) jxm_Name
